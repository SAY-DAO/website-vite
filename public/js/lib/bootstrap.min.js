    ...
    return (
      ...
      (t.to = function (t) {
        ...
        if (!(t > this._items.length - 1 || t < 0)) {
          if (this._isSliding) { g(this._element).one(Y.SLID, () => e.to(t)); } else {
  ...
  const wt = (function () {
    ...
    return (
            ...
            && (this._parent
              && (t = [].slice
                ...
                .filter((t) => (typeof n._config.parent === 'string'
                  ...
                  : t.classList.contains(Et)))).length
                === 0
              && (t = null),
            !(
              t
      ...
      (t._getParent = function () {
        ...
        const e = `[data-toggle="collapse"][data-parent="${
          this._config.parent
        }"]`;
  ...
  const Yn = (function () {
    ...
    return (
      ...
      (t._activate = function (t, e, n) {
        ...
        var o = this;
        var r = (!e || (e.nodeName !== 'UL' && e.nodeName !== 'OL')
          ? g(e).children(Mn)
          : g(e).find(Kn))[0];
