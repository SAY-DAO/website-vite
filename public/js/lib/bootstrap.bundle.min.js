...
!(function (e, t) {
  ...
  var m = {
    ...
    getTransitionDurationFromElement(e) {
      if (!e) return 0;
      let t = p(e).css('transition-duration');
      let n = p(e).css('transition-delay');
    ...
    jQueryDetection() {
      ...
      const e = p.fn.jquery.split(' ')[0].split('.');
      if (
        (e[0] < 2 && e[1] < 9)
        || (e[0] === 1 && e[1] === 9 && e[2] < 1)
        || e[0] >= 4
  ...
  const _ = (function () {
    ...
    return (
      ...
      (e._triggerCloseEvent = function (e) {
        const t = p.Event(u.CLOSE);
        return p(e).trigger(t), t;
      }),
      (e._removeElement = function (t) {
        const n = this;
        if ((p(t).removeClass(g), p(t).hasClass(d))) {
          const e = m.getTransitionDurationFromElement(t);
          p(t)
            .one(m.TRANSITION_END, (e) => n._destroyElement(t, e))
      ...
      (i._jQueryInterface = function (n) {
        return this.each(function () {
          const e = p(this);
          let t = e.data(a);
          t || ((t = new i(this)), e.data(a, t)), n === 'close' && t[n](this);
        });
      }),
  ...
  const I = '[data-toggle="buttons"]';
  const A = '[data-toggle="button"]';
  const O = '[data-toggle="buttons"] .btn';
  const N = 'input:not([type="hidden"])';
  const k = '.active';
  const L = '.btn';
  const P = {
  ...
  const x = (function () {
    ...
    return (
      (e.toggle = function () {
        let e = !0;
        let t = !0;
        const n = p(this._element).closest(I)[0];
        if (n) {
          const i = this._element.querySelector(N);
          if (i) {
            if (i.type === 'radio') {
              if (i.checked && this._element.classList.contains(T)) e = !1;
              else {
                const o = n.querySelector(k);
                o && p(o).removeClass(T);
              }
            } else {
              i.type === 'checkbox'
  ...
  p(document)
    ...
    .on(P.FOCUS_BLUR_DATA_API, D, (e) => {
      const t = p(e.target).closest(L)[0];
  ...
  p(window).on(P.LOAD_DATA_API, () => {
    ...
    for (
      let r = 0, s = (e = [].slice.call(document.querySelectorAll(A))).length;
      r < s;
      r++
    ) {
      const a = e[r];
  ...
  const $ = 'carousel-item-left';
  const J = 'carousel-item-next';
  const Z = 'carousel-item-prev';
  const ee = 'pointer-event';
  const te = '.active';
  const ne = '.active.carousel-item';
  const ie = '.carousel-item';
  const oe = '.carousel-item img';
  const re = '.carousel-item-next, .carousel-item-prev';
  const se = '.carousel-indicators';
  const ae = '[data-slide], [data-slide-to]';
  const le = '[data-ride="carousel"]';
  const ce = { TOUCH: 'touch', PEN: 'pen' };
  const he = (function () {
    function r(e, t) {
      (this._items = null),
      (this._interval = null),
    ...
    return (
      ...
      (e.to = function (e) {
        ...
        if (!(e > this._items.length - 1 || e < 0)) {
          if (this._isSliding) { p(this._element).one(V.SLID, () => t.to(e)); } else {
      ...
      (e._addEventListeners = function () {
        ...
        this._config.keyboard
            && p(this._element).on(V.KEYDOWN, (e) => t._keydown(e)),
      ...
      (e._addTouchEventListeners = function () {
        ...
        if (this._touchSupported) {
          ...
          this._pointerEvent
            ...
            p(this._element).on(V.TOUCHMOVE, (e) => (function (e) {
      ...
      (e._getItemByDirection = function (e, t) {
        ...
        const s = (o + (e === q ? -1 : 1)) % this._items.length;
        return s == -1 ? this._items[this._items.length - 1] : this._items[s];
      }),
      (e._triggerSlideEvent = function (e, t) {
        const n = this._getItemIndex(e);
        const i = this._getItemIndex(this._element.querySelector(ne));
        const o = p.Event(V.SLIDE, {
          relatedTarget: e,
          direction: t,
          from: i,
          to: n,
      ...
      (e._setActiveIndicatorElement = function (e) {
        if (this._indicatorsElement) {
          const t = [].slice.call(this._indicatorsElement.querySelectorAll(te));
          p(t).removeClass(z);
      ...
      (e._slide = function (e, t) {
        ...
        let o;
        const r = this;
        const s = this._element.querySelector(ne);
        const a = this._getItemIndex(s);
        const l = t || (s && this._getItemByDirection(e, s));
      ...
      (r._jQueryInterface = function (i) {
        return this.each(function () {
          let e = p(this).data(H);
          let t = l({}, W, {}, p(this).data());
          typeof i === 'object' && (t = l({}, t, {}, i));
          const n = typeof i === 'string' ? i : t.slide;
          if (
      ...
      (r._dataApiClickHandler = function (e) {
        const t = m.getSelectorFromElement(this);
        if (t) {
          const n = p(t)[0];
          if (n && p(n).hasClass(Y)) {
  ...
  p(window).on(V.LOAD_DATA_API, () => {
    for (
      let e = [].slice.call(document.querySelectorAll(le)),
        t = 0,
        n = e.length;
      t < n;
      t++
  ...
  const ue = 'collapse';
  const fe = 'bs.collapse';
  const de = `.${fe}`;
  const pe = p.fn[ue];
  const me = { toggle: !0, parent: '' };
  const ge = { toggle: 'boolean', parent: '(string|element)' };
  const _e = {
    SHOW: `show${de}`,
    SHOWN: `shown${de}`,
    HIDE: `hide${de}`,
  ...
  const we = 'width';
  const Te = 'height';
  const Ce = '.show, .collapsing';
  const Se = '[data-toggle="collapse"]';
  const De = (function () {
    function a(t, e) {
      ...
      for (
        let n = [].slice.call(document.querySelectorAll(Se)),
          i = 0,
          o = n.length;
        i < o;
        i++
    ...
    return (
          ...
          !this._isTransitioning
            ...
            && (this._parent
              && (e = [].slice
                ...
                .filter((e) => (typeof n._config.parent === 'string'
                  ? e.getAttribute('data-parent') === n._config.parent
                  : e.classList.contains(ye)))).length
                === 0
              && (e = null),
            !(
              e
      ...
      (e._getParent = function () {
        ...
        const t = `[data-toggle="collapse"][data-parent="${
          this._config.parent
        }"]`;
      ...
      (a._jQueryInterface = function (i) {
        return this.each(function () {
          ...
          if (
            ...
            if (typeof t[i] === 'undefined') throw new TypeError(`No method named "${i}"`);
            t[i]();
          }
        });
      }),
  ...
  p(document).on(_e.CLICK_DATA_API, Se, function (e) {
    ...
    const n = p(this);
    const t = m.getSelectorFromElement(this);
    const i = [].slice.call(document.querySelectorAll(t));
    p(i).each(function () {
      const e = p(this);
      const t = e.data(fe) ? 'toggle' : n.data();
  ...
  const Ae = (function () {
    for (let e = ['Edge', 'Trident', 'Firefox'], t = 0; t < e.length; t += 1) if (Ie && navigator.userAgent.indexOf(e[t]) >= 0) return 1;
    return 0;
  }());
  const Oe = Ie && window.Promise
    ? function (e) {
      let t = !1;
      return function () {
        t
  ...
  const je = Ie && !(!window.MSInputMethodContext || !document.documentMode);
  const He = Ie && /MSIE 10/.test(navigator.userAgent);
  function Re(e) {
    return e === 11 ? je : e === 10 ? He : je || He;
  }
  function Fe(e) {
  ...
  function Me(e) {
    return e.parentNode !== null ? Me(e.parentNode) : e;
  }
  function We(e, t) {
    ...
    if ((e !== s && t !== s) || i.contains(o)) {
      return (function (e) {
        const t = e.nodeName;
        return t !== 'BODY' && (t === 'HTML' || Fe(e.firstElementChild) === e);
      }(s))
        ? s
        : Fe(s);
    }
  ...
  function Ue(e, t) {
    const n = (arguments.length > 1 && void 0 !== t ? t : 'top') === 'top'
      ? 'scrollTop'
      : 'scrollLeft';
    const i = e.nodeName;
    if (i !== 'BODY' && i !== 'HTML') return e[n];
  ...
  function Ke(e) {
    ...
    const i = Re(10) && getComputedStyle(n);
  ...
  function Ge(e) {
    ...
    const r = e.nodeName === 'HTML' ? Ke(e.ownerDocument) : {};
    const s = r.width || e.clientWidth || o.width;
    const a = r.height || e.clientHeight || o.height;
  ...
  function $e(e, t, n) {
    ...
    const o = Re(10);
    const r = t.nodeName === 'HTML';
    const s = Ge(e);
    const a = Ge(t);
    const l = Pe(e);
    const c = ke(t);
    const h = parseFloat(c.borderTopWidth, 10);
    const u = parseFloat(c.borderLeftWidth, 10);
    ...
    if (((f.marginTop = 0), (f.marginLeft = 0), !o && r)) {
      const d = parseFloat(c.marginTop, 10);
      const p = parseFloat(c.marginLeft, 10);
      (f.top -= h - d),
      (f.bottom -= h - d),
      (f.left -= u - p),
      (f.right -= u - p),
    ...
    return (
      (o && !i ? t.contains(l) : t === l && l.nodeName !== 'BODY')
        && (f = (function (e, t, n) {
          const i = arguments.length > 2 && void 0 !== n && n;
          const o = Ue(t, 'top');
          const r = Ue(t, 'left');
  ...
  function Je(e) {
    ...
    for (var t = e.parentElement; t && ke(t, 'transform') === 'none';) t = t.parentElement;
    return t || document.documentElement;
  }
  function Ze(e, t, n, i, o) {
    const r = arguments.length > 4 && void 0 !== o && o;
    let s = { top: 0, left: 0 };
    const a = r ? Je(e) : We(e, xe(t));
    if (i === 'viewport') {
      s = (function (e, t) {
        const n = arguments.length > 1 && void 0 !== t && t;
        const i = e.ownerDocument.documentElement;
        const o = $e(e, i);
        const r = Math.max(i.clientWidth, window.innerWidth || 0);
        const s = Math.max(i.clientHeight, window.innerHeight || 0);
        const a = n ? 0 : Ue(i);
        const l = n ? 0 : Ue(i, 'left');
        return Xe({
      ...
      let l = void 0;
      i === 'scrollParent'
        ? (l = Pe(Le(t))).nodeName === 'BODY'
          && (l = e.ownerDocument.documentElement)
        : (l = i === 'window' ? e.ownerDocument.documentElement : i);
      const c = $e(l, a, r);
      if (
        l.nodeName !== 'HTML'
        || (function e(t) {
          ...
          if (ke(t, 'position') === 'fixed') return !0;
          const i = Le(t);
          return !!i && e(i);
        }(a))
      ) s = c;
      else {
        const h = Ke(e.ownerDocument);
        const u = h.height;
        const f = h.width;
  ...
  function et(e, t, i, n, o, r) {
    const s = arguments.length > 5 && void 0 !== r ? r : 0;
    ...
    const u = h.length > 0 ? h[0].key : c[0].key;
    const f = e.split('-')[1];
    return u + (f ? `-${f}` : '');
  }
  function tt(e, t, n, i) {
    const o = arguments.length > 3 && void 0 !== i ? i : null;
  ...
  function ht(e, t, n, i) {
    ...
    return (
      (function e(t, n, i, o) {
        const r = t.nodeName === 'BODY';
        const s = r ? t.ownerDocument.defaultView : t;
  ...
  function dt(n, i) {
    Object.keys(i).forEach((e) => {
      let t = '';
      ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(e) !== -1
        && ft(i[e])
        && (t = 'px'),
      (n.style[e] = i[e] + t);
    });
  ...
  function pt(e, t) {
    ...
    const l = s(r.width);
    const c = s(o.width);
    const h = ['left', 'right'].indexOf(e.placement) !== -1;
    const u = e.placement.indexOf('-') !== -1;
    const f = t ? (h || u || l % 2 == c % 2 ? s : a) : n;
    const d = t ? s : n;
    return {
  ...
  const mt = Ie && /Firefox/i.test(navigator.userAgent);
  function gt(e, t, n) {
    const i = rt(e, (e) => e.name === t);
    const o = !!i
        && e.some((e) => e.name === n && e.enabled && e.order < i.order);
    if (!o) {
      const r = `\`${t}\``;
      const s = `\`${n}\``;
      console.warn(
  ...
  function yt(e, t) {
    const n = arguments.length > 1 && void 0 !== t && t;
    const i = vt.indexOf(e);
    const o = vt.slice(i + 1).concat(vt.slice(0, i));
    return n ? o.reverse() : o;
  }
  const Et = 'flip';
  const bt = 'clockwise';
  const wt = 'counterclockwise';
  function Tt(e, o, r, t) {
    const s = [0, 0];
    const a = ['right', 'left'].indexOf(t) !== -1;
  ...
  const Ct = {
    ...
    modifiers: {
      ...
      preventOverflow: {
        ...
        enabled: !0,
        fn(e, i) {
          let t = i.boundariesElement || Fe(e.instance.popper);
          e.instance.reference === t && (t = Fe(t));
          const n = lt('transform');
          ...
          return (
            c.forEach((e) => {
              const t = ['left', 'top'].indexOf(e) !== -1 ? 'primary' : 'secondary';
              h = { ...h, ...u[t](e) };
            }),
            (e.offsets.popper = h),
            e
      ...
      flip: {
        ...
        fn(m, g) {
          ...
          let v = m.placement.split('-')[0];
          let y = it(v);
          let E = m.placement.split('-')[1] || '';
          let b = [];
          switch (g.behavior) {
            case Et:
              b = [v, y];
          ...
          return (
            b.forEach((e, t) => {
              ...
              const n = m.offsets.popper;
              const i = m.offsets.reference;
              const o = Math.floor;
              const r = (v === 'left' && o(n.right) > o(i.left))
                    || (v === 'right' && o(n.left) < o(i.right))
                    || (v === 'top' && o(n.bottom) > o(i.top))
                    || (v === 'bottom' && o(n.top) < o(i.bottom));
              const s = o(n.left) < o(_.left);
              const a = o(n.right) > o(_.right);
              const l = o(n.top) < o(_.top);
              const c = o(n.bottom) > o(_.bottom);
              const h = (v === 'left' && s)
                    || (v === 'right' && a)
                    || (v === 'top' && l)
                    || (v === 'bottom' && c);
              const u = ['top', 'bottom'].indexOf(v) !== -1;
              const f = !!g.flipVariations
                    && ((u && E === 'start' && s)
                      || (u && E === 'end' && a)
                      || (!u && E === 'start' && l)
                      || (!u && E === 'end' && c));
              const d = !!g.flipVariationsByContent
                    && ((u && E === 'start' && a)
                      || (u && E === 'end' && s)
                      || (!u && E === 'start' && c)
                      || (!u && E === 'end' && l));
      ...
      hide: {
        ...
        fn(e) {
          ...
          const n = rt(e.instance.modifiers, (e) => e.name === 'preventOverflow').boundaries;
          if (
            t.bottom < n.top
              || t.left > n.right
              || t.top > n.bottom
      ...
      computeStyle: {
        ...
        fn(e, t) {
          ...
          const r = rt(e.instance.modifiers, (e) => e.name === 'applyStyle').gpuAcceleration;
          void 0 !== r
              && console.warn(
                'WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!',
              );
          const s = void 0 !== r ? r : t.gpuAcceleration;
          const a = Fe(e.instance.popper);
          const l = Ge(a);
          const c = { position: o.position };
          const h = pt(e, window.devicePixelRatio < 2 || !mt);
          const u = n === 'bottom' ? 'top' : 'bottom';
          const f = i === 'right' ? 'left' : 'right';
          const d = lt('transform');
          let p = void 0;
          let m = void 0;
          if (
            ((m = u == 'bottom'
      ...
      applyStyle: {
        ...
        onLoad(e, t, n, i, o) {
          const r = tt(o, t, e, n.positionFixed);
          const s = et(
            n.placement,
            r,
            t,
  ...
  function Dt(e, t) {
    ...
    (this.options = { ...Dt.Defaults, ...i }),
    (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
    (this.reference = e && e.jquery ? e[0] : e),
    (this.popper = t && t.jquery ? t[0] : t),
    (this.options.modifiers = {}),
    Object.keys({ ...Dt.Defaults.modifiers, ...i.modifiers }).forEach((
      e,
    ) => {
  ...
  (St.Utils = (typeof window !== 'undefined' ? window : global).PopperUtils),
  (St.placements = _t),
  (St.Defaults = Ct);
  const It = 'dropdown';
  const At = 'bs.dropdown';
  const Ot = `.${At}`;
  const Nt = '.data-api';
  const kt = p.fn[It];
  ...
  const Rt = 'dropright';
  const Ft = 'dropleft';
  const Mt = 'dropdown-menu-right';
  const Wt = 'position-static';
  const Ut = '[data-toggle="dropdown"]';
  const Bt = '.dropdown form';
  const qt = '.dropdown-menu';
  const Kt = '.navbar-nav';
  const Qt = '.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)';
  const Vt = 'top-start';
  const Yt = 'top-end';
  const zt = 'bottom-start';
  const Xt = 'bottom-end';
    ...
    return (
      (e.toggle = function () {
        if (!this._element.disabled && !p(this._element).hasClass(xt)) {
          const e = p(this._menu).hasClass(jt);
        ...
        if (
          ...
          if ((p(i).trigger(n), !n.isDefaultPrevented())) {
            if (!this._inNavbar && e) {
              ...
              this._config.boundary !== 'scrollParent' && p(i).addClass(Wt),
              (this._popper = new St(
                o,
                this._menu,
      ...
      (e._getMenuElement = function () {
        if (!this._menu) {
          const e = c._getParentFromElement(this._element);
          e && (this._menu = e.querySelector(qt));
        }
        return this._menu;
      }),
      (e._getPlacement = function () {
        const e = p(this._element.parentNode);
        let t = zt;
        return (
          e.hasClass(Ht)
      ...
      (c._jQueryInterface = function (t) {
        return this.each(function () {
          let e = p(this).data(At);
          if (
            (e
                || ((e = new c(this, typeof t === 'object' ? t : null)),
                p(this).data(At, e)),
            typeof t === 'string')
          ) {
      ...
      (c._clearMenus = function (e) {
        if (!e || (e.which !== 3 && (e.type !== 'keyup' || e.which === 9))) {
          for (
            let t = [].slice.call(document.querySelectorAll(Ut)),
              n = 0,
              i = t.length;
            n < i;
            n++
          ) {
            const o = c._getParentFromElement(t[n]);
            const r = p(t[n]).data(At);
            const s = { relatedTarget: t[n] };
            if ((e && e.type === 'click' && (s.clickEvent = e), r)) {
              const a = r._menu;
              if (
                p(o).hasClass(jt)
                  && !(
      ...
      (c._getParentFromElement = function (e) {
        let t;
        const n = m.getSelectorFromElement(e);
      ...
      (c._dataApiKeydownHandler = function (e) {
        if (
          ...
          const t = c._getParentFromElement(this);
          const n = p(t).hasClass(jt);
          if (n || e.which !== 27) {
            if (n && (!n || (e.which !== 27 && e.which !== 32))) {
              const i = [].slice
              ...
              if (i.length !== 0) {
                ...
                e.which === 38 && o > 0 && o--,
                e.which === 40 && o < i.length - 1 && o++,
                o < 0 && (o = 0),
                i[o].focus();
              }
            } else {
              if (e.which === 27) {
                const r = t.querySelector(Ut);
                p(r).trigger('focus');
              }
  ...
  const cn = 'modal-dialog-scrollable';
  const hn = 'modal-scrollbar-measure';
  const un = 'modal-backdrop';
  const fn = 'modal-open';
  const dn = 'fade';
  const pn = 'show';
  const mn = 'modal-static';
  const gn = '.modal-dialog';
  const _n = '.modal-body';
  const vn = '[data-toggle="modal"]';
  const yn = '[data-dismiss="modal"]';
    ...
    return (
      ...
      (e.show = function (e) {
        ...
        if (!this._isShown && !this._isTransitioning) {
          ...
          const n = p.Event(ln.SHOW, { relatedTarget: e });
          ...
          this._isShown
                ...
                p(this._element).on(ln.CLICK_DISMISS, yn, (e) => t.hide(e)),
                p(this._dialog).on(ln.MOUSEDOWN_DISMISS, () => {
                  p(t._element).one(ln.MOUSEUP_DISMISS, (e) => {
                    p(e.target).is(t._element) && (t._ignoreBackdropClick = !0);
                  });
                }),
                this._showBackdrop(() => t._showElement(e)));
        }
      }),
      (e.hide = function (e) {
        const t = this;
        if (
          ...
          const n = p.Event(ln.HIDE);
          if (
            (p(this._element).trigger(n),
            this._isShown && !n.isDefaultPrevented())
          ) {
            this._isShown = !1;
            const i = p(this._element).hasClass(dn);
            if (
              ...
              p(this._element)
                .one(m.TRANSITION_END, (e) => t._hideModal(e))
      ...
      (e._triggerBackdropTransition = function () {
        ...
        if (this._config.backdrop === 'static') {
          const t = p.Event(ln.HIDE_PREVENTED);
      ...
      (e._showElement = function (e) {
        const t = this;
        const n = p(this._element).hasClass(dn);
        const i = this._dialog ? this._dialog.querySelector(_n) : null;
        ...
        if (n) {
          const s = m.getTransitionDurationFromElement(this._dialog);
      ...
      (e._enforceFocus = function () {
        ...
        p(document)
          ...
          .on(ln.FOCUSIN, (e) => {
            document !== e.target
                && t._element !== e.target
                && p(t._element).has(e.target).length === 0
                && t._element.focus();
          });
      }),
      (e._setEscapeEvent = function () {
        ...
        this._isShown && this._config.keyboard
          ? p(this._element).on(ln.KEYDOWN_DISMISS, (e) => {
            e.which === 27 && t._triggerBackdropTransition();
          })
      ...
      (e._setResizeEvent = function () {
        const t = this;
        this._isShown
          ? p(window).on(ln.RESIZE, (e) => t.handleUpdate(e))
      ...
      (e._showBackdrop = function (e) {
        const t = this;
        const n = p(this._element).hasClass(dn) ? dn : '';
      ...
      (e._setScrollbar = function () {
        ...
        if (this._isBodyOverflowing) {
          const e = [].slice.call(document.querySelectorAll(En));
          const t = [].slice.call(document.querySelectorAll(bn));
          p(e).each((e, t) => {
            const n = t.style.paddingRight;
            const i = p(t).css('padding-right');
            p(t)
      ...
      (e._resetScrollbar = function () {
        const e = [].slice.call(document.querySelectorAll(En));
        p(e).each((e, t) => {
          const n = p(t).data('padding-right');
          p(t).removeData('padding-right'), (t.style.paddingRight = n || '');
        });
        const t = [].slice.call(document.querySelectorAll(`${bn}`));
        p(t).each((e, t) => {
          const n = p(t).data('margin-right');
          typeof n !== 'undefined'
  ...
  p(document).on(ln.CLICK_DATA_API, vn, function (e) {
    ...
    const o = p(t).data(nn) ? 'toggle' : l({}, p(t).data(), {}, p(this).data());
  ...
  const Dn = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i;
  function In(e, r, t) {
    if (e.length === 0) return e;
    if (t && typeof t === 'function') return t(e);
    for (
      var n = new window.DOMParser().parseFromString(e, 'text/html'),
        ...
        i = function (e) {
          ...
          if (s.indexOf(t.nodeName.toLowerCase()) === -1) return t.parentNode.removeChild(t), 'continue';
          const i = [].slice.call(t.attributes);
          ...
          i.forEach((e) => {
            !(function (e, t) {
              ...
              for (
                let i = t.filter((e) => e instanceof RegExp),
                  o = 0,
                  r = i.length;
                o < r;
                o++
  ...
  const kn = p.fn[An];
  const Ln = 'bs-tooltip';
  const Pn = new RegExp(`(^|\\s)${Ln}\\S+`, 'g');
  const xn = ['sanitize', 'whiteList', 'sanitizeFn'];
  const jn = {
    animation: 'boolean',
    template: 'string',
  ...
  const Xn = (function () {
    ...
    return (
      ...
      (e.toggle = function (e) {
        if (this._isEnabled) {
          if (e) {
            ...
            let n = p(e.currentTarget).data(t);
            n
      ...
      (e.show = function () {
        const t = this;
        if (p(this.element).css('display') === 'none') throw new Error('Please use show on visible elements');
        const e = p.Event(this.constructor.Event.SHOW);
      ...
      (e.hide = function (e) {
        ...
        const o = p.Event(this.constructor.Event.HIDE);
        if ((p(this.element).trigger(o), !o.isDefaultPrevented())) {
          if (
            ...
            const r = m.getTransitionDurationFromElement(i);
      ...
      (e.setElementContent = function (e, t) {
        typeof t !== 'object' || (!t.nodeType && !t.jquery)
          ? this.config.html
      ...
      (e._setListeners = function () {
        ...
        this.config.trigger.split(' ').forEach((e) => {
          if (e === 'click') {
            ...
            p(i.element)
              .on(t, i.config.selector, (e) => i._enter(e))
              .on(n, i.config.selector, (e) => i._leave(e));
          }
        }),
      ...
      (e._enter = function (e, t) {
        ...
        e && (t._activeTrigger[e.type === 'focusin' ? Vn : Qn] = !0),
      ...
      (e._leave = function (e, t) {
        ...
        (t = t || p(e.currentTarget).data(n))
            ...
            p(e.currentTarget).data(n, t)),
        e && (t._activeTrigger[e.type === 'focusout' ? Vn : Qn] = !1),
      ...
      (e._getConfig = function (e) {
        const t = p(this.element).data();
        return (
          Object.keys(t).forEach((e) => {
            xn.indexOf(e) !== -1 && delete t[e];
          }),
          typeof (e = l(
            {},
            this.constructor.Default,
      ...
      (e._cleanTipClass = function () {
        const e = p(this.getTipElement());
        const t = e.attr('class').match(Pn);
      ...
      (i._jQueryInterface = function (n) {
        return this.each(function () {
          let e = p(this).data(On);
          const t = typeof n === 'object' && n;
          if (
  ...
  const Zn = p.fn[Gn];
  const ei = 'bs-popover';
  const ti = new RegExp(`(^|\\s)${ei}\\S+`, 'g');
  const ni = l({}, Xn.Default, {
    placement: 'right',
    trigger: 'click',
    content: '',
    template:
  ...
  const ii = l({}, Xn.DefaultType, { content: '(string|element|function)' });
  const oi = 'fade';
  const ri = 'show';
  const si = '.popover-header';
  const ai = '.popover-body';
  const li = {
    HIDE: `hide${Jn}`,
    HIDDEN: `hidden${Jn}`,
    SHOW: `show${Jn}`,
  ...
  const ci = (function (e) {
    ...
    return (
      ...
      (t._cleanTipClass = function () {
        const e = p(this.getTipElement());
        const t = e.attr('class').match(ti);
        t !== null && t.length > 0 && e.removeClass(t.join(''));
      }),
      (i._jQueryInterface = function (n) {
        return this.each(function () {
          let e = p(this).data($n);
          const t = typeof n === 'object' ? n : null;
          if (
            (e || !/dispose|hide/.test(n))
  ...
  const hi = 'scrollspy';
  const ui = 'bs.scrollspy';
  const fi = `.${ui}`;
  const di = p.fn[hi];
  const pi = { offset: 10, method: 'auto', target: '' };
  const mi = { offset: 'number', method: 'string', target: '(string|element)' };
  const gi = {
    ACTIVATE: `activate${fi}`,
    SCROLL: `scroll${fi}`,
    LOAD_DATA_API: `load${fi}.data-api`,
  };
  const _i = 'dropdown-item';
  const vi = 'active';
  const yi = '[data-spy="scroll"]';
  const Ei = '.nav, .list-group';
  const bi = '.nav-link';
  const wi = '.nav-item';
  const Ti = '.list-group-item';
  const Ci = '.dropdown';
  const Si = '.dropdown-item';
  const Di = '.dropdown-toggle';
  const Ii = 'offset';
  const Ai = 'position';
  const Oi = (function () {
    function n(e, t) {
      ...
      p(this._scrollElement).on(gi.SCROLL, (e) => n._process(e)),
      this.refresh(),
      this._process();
    }
    const e = n.prototype;
    return (
      (e.refresh = function () {
        const t = this;
        const e = this._scrollElement === this._scrollElement.window ? Ii : Ai;
        const o = this._config.method === 'auto' ? e : this._config.method;
        const r = o === Ai ? this._getScrollTop() : 0;
        (this._offsets = []),
        (this._targets = []),
      ...
      (e._getConfig = function (e) {
        if (
          typeof (e = l({}, pi, {}, typeof e === 'object' && e ? e : {}))
            .target
            !== 'string'
        ) {
          let t = p(e.target).attr('id');
      ...
      (e._activate = function (t) {
        ...
        const n = p([].slice.call(document.querySelectorAll(e.join(','))));
        n.hasClass(_i)
      ...
      (n._jQueryInterface = function (t) {
        return this.each(function () {
          let e = p(this).data(ui);
          if (
            (e
                || ((e = new n(this, typeof t === 'object' && t)),
                p(this).data(ui, e)),
            typeof t === 'string')
          ) {
            if (typeof e[t] === 'undefined') throw new TypeError(`No method named "${t}"`);
  ...
  p(window).on(gi.LOAD_DATA_API, () => {
    for (
      let e = [].slice.call(document.querySelectorAll(yi)), t = e.length;
      t--;
  ...
  const xi = 'dropdown-menu';
  const ji = 'active';
  const Hi = 'disabled';
  const Ri = 'fade';
  const Fi = 'show';
  const Mi = '.dropdown';
  const Wi = '.nav, .list-group';
  const Ui = '.active';
  const Bi = '> li > .active';
  const qi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]';
  const Ki = '.dropdown-toggle';
  const Qi = '> .dropdown-menu .active';
  const Vi = (function () {
    function i(e) {
      this._element = e;
    }
    ...
    return (
      (e.show = function () {
        ...
        if (
          ...
          let e;
          let i;
          const t = p(this._element).closest(Wi)[0];
          const o = m.getSelectorFromElement(this._element);
          if (t) {
            const r = t.nodeName === 'UL' || t.nodeName === 'OL' ? Bi : Ui;
            i = (i = p.makeArray(p(t).find(r)))[i.length - 1];
          }
          const s = p.Event(Pi.HIDE, { relatedTarget: this._element });
          const a = p.Event(Pi.SHOW, { relatedTarget: i });
          if (
            (i && p(i).trigger(s),
            ...
            const l = function () {
              const e = p.Event(Pi.HIDDEN, { relatedTarget: n._element });
              const t = p.Event(Pi.SHOWN, { relatedTarget: i });
      ...
      (e._activate = function (e, t, n) {
        ...
        var o = this;
        var r = (!t || (t.nodeName !== 'UL' && t.nodeName !== 'OL')
          ? p(t).children(Ui)
          : p(t).find(Bi))[0];
        const s = n && r && p(r).hasClass(Ri);
        if (r && s) {
          const a = m.getTransitionDurationFromElement(r);
          p(r)
            .removeClass(Fi)
      ...
      (e._transitionComplete = function (e, t, n) {
        if (t) {
          p(t).removeClass(ji);
          const i = p(t.parentNode).find(Qi)[0];
        ...
        if (
          ...
          const o = p(e).closest(Mi)[0];
          if (o) {
            const r = [].slice.call(o.querySelectorAll(Ki));
            p(r).addClass(ji);
          }
      ...
      (i._jQueryInterface = function (n) {
        return this.each(function () {
          ...
          let t = e.data(Ni);
          if (
            (t || ((t = new i(this)), e.data(Ni, t)), typeof n === 'string')
          ) {
  ...
  const eo = 'show';
  const to = 'showing';
  const no = { animation: 'boolean', autohide: 'boolean', delay: 'number' };
  const io = { animation: !0, autohide: !0, delay: 500 };
  const oo = '[data-dismiss="toast"]';
  const ro = (function () {
    function i(e, t) {
      (this._element = e),
      (this._config = this._getConfig(t)),
    ...
    return (
      (e.show = function () {
        ...
        if ((p(this._element).trigger(t), !t.isDefaultPrevented())) {
          ...
          if (
            ...
            const i = m.getTransitionDurationFromElement(this._element);
      ...
      (e._setListeners = function () {
        const e = this;
        p(this._element).on($i.CLICK_DISMISS, oo, () => e.hide());
      }),
      (e._close = function () {
        function e() {
      ...
      (i._jQueryInterface = function (n) {
        return this.each(function () {
          ...
          if (
            (t
                || ((t = new i(this, typeof n === 'object' && n)), e.data(zi, t)),
            typeof n === 'string')
          ) {
            if (typeof t[n] === 'undefined') throw new TypeError(`No method named "${n}"`);
            t[n](this);
